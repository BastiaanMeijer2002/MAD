...
class ProfileWidget extends StatefulWidget {
  ...
  const ProfileWidget({super.key, required this.storage, required this.rentals, required this.customers});
...
class _ProfileWidgetState extends State<ProfileWidget>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: fetchCustomer(widget.storage, widget.customers),
                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                            padding: EdgeInsets.only(top: screenHeight * 0.02, left: screenWidth * 0.06,),
                            child: ActiveRentalsWidget(customer: customer, rentals: widget.rentals),
                        ),
                      ),
                      Align(
                        alignment: Alignment.topLeft,
                        child: Padding(
                          padding: EdgeInsets.only(top: screenHeight * 0.02, left: screenWidth * 0.06,),
                          child: UpcomingRentalsWidget(customer: customer, rentals: widget.rentals),
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(top: screenHeight * 0.02, left: screenWidth * 0.06,),
                          child: FinishedRentalsWidget(customer: customer, rentals: widget.rentals),
                        ),
                      )
                    ],
                  ),
